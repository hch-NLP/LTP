...
# Author: HKH<xtuhch@126.com>
# Date: 18-3-12
from EventTripletExtraction.sentence_parser import *
import re
...
if __name__ == '__main__':
    ...
    triples = extractor.triples_main(content4)
    print('result', triples)
    triples = extractor.triples_main(content2)
    print('result', triples)